...
march_ref_df.index = pd.to_datetime(march_ref_df.index)
...
march_ref_df = match_dates(march_ref_df, march_df1, march_df2)[0]
march_df1 = match_dates(march_ref_df, march_df1, march_df2)[1]
...
dtype={'TimeBeginning': 'object', 'NO_Scaled': np.float64, 'NO2_Scaled': np.float64, 'NOx_Scaled': np.float64, 'O3_Scaled': np.float64, 'WD_Scaled': np.float64, 'TEMP_Scaled': np.float64, 'HUM_Scaled': np.float64, 'WINDMS_Scaled': np.float64})
april_ref_df.index = pd.to_datetime(april_ref_df.index)
...
# Match start and finish of datalog for april
april_ref_df = match_dates(april_ref_df, april_df1, april_df2)[0]
april_df1 = match_dates(april_ref_df, april_df1, april_df2)[1]
...
dtype={'TimeBeginning': 'object', 'NO_Scaled': np.float64, 'NO2_Scaled': np.float64, 'NOx_Scaled': np.float64, 'O3_Scaled': np.float64, 'WD_Scaled': np.float64, 'TEMP_Scaled': np.float64, 'HUM_Scaled': np.float64, 'WINDMS_Scaled': np.float64})
may_ref_df.index = pd.to_datetime(may_ref_df.index)
...
may_ref_df = match_dates(may_ref_df, may_df1, may_df2)[0]
may_df1 = match_dates(may_ref_df, may_df1, may_df2)[1]
